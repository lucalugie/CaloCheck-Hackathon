...
async function overveg() {
    ...
    const overveg = await noticonmonths.findAll({ 
        attributes: [
            'userlineid',
...
async function checklistoveveg(id,date) {
