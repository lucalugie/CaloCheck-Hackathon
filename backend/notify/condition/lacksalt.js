...
async function lacksalt() {
    ...
    const lacksalt = await noticonmonths.findAll({ 
        attributes: [
            'userlineid',
...
function getLast7Days() {
 ...
 async function checklistlacksalt(id,date) {
