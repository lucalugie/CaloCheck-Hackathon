...
function lackcalnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function lackcalnoti$(_context) {
    while (1) {
...
function lackofcal() {
  var today, Todayly, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, lackcal;
  return regeneratorRuntime.async(function lackofcal$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          today = new Date();
          Todayly = today.toLocaleDateString();
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('lackofcal')), 'lackofcal']],
            where: {
        ...
        case 19:
          lackcal = _context3.sent;
          lackcal.forEach(function _callee(e) {
            var lastDayOfMonth, lackcalPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดโปรตีน " + e.lackofcal + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    lackcalPercent = e.lackofcal / lastDayOfMonth * 100;
...
function checklistlackcal(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistlackcal$(_context7) {
    while (1) {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "\u0E40\u0E2E\u0E49! ".concat(name, " \u0E04\u0E38\u0E13\u0E01\u0E34\u0E19\u0E2D\u0E32\u0E2B\u0E32\u0E23\u0E44\u0E21\u0E48\u0E16\u0E36\u0E07\u0E40\u0E40\u0E04\u0E25\u0E2D\u0E23\u0E35\u0E48\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22\u0E21\u0E32 7 \u0E27\u0E31\u0E19\u0E40\u0E40\u0E25\u0E49\u0E27\u0E19\u0E30")
            }, {
              "type": "text",
