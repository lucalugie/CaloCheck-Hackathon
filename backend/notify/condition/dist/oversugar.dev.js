...
function oversugarnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function oversugarnoti$(_context) {
    while (1) {
...
function oversugar() {
  var today, Todaysent, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, oversugar;
  return regeneratorRuntime.async(function oversugar$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('oversugar')), 'oversugar']],
            where: {
        ...
        case 19:
          oversugar = _context3.sent;
          oversugar.forEach(function _callee(e) {
            var lastDayOfMonth, oversugarPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดsugar " + e.oversugar + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    oversugarPercent = e.oversugar / lastDayOfMonth * 100;
...
function checklistovesugar(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistovesugar$(_context7) {
    while (1) {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "".concat(name, " \u0E04\u0E38\u0E13\u0E01\u0E34\u0E19\u0E2B\u0E27\u0E32\u0E19\u0E40\u0E01\u0E34\u0E19\u0E21\u0E32\u0E2B\u0E25\u0E32\u0E22\u0E27\u0E31\u0E19\u0E40\u0E40\u0E25\u0E49\u0E27\u0E19\u0E30 (\uFF61\u2022\u0301\uFE3F\u2022\u0300\uFF61)")
            }, {
              "type": "image",
