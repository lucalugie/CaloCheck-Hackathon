...
function overcalnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function overcalnoti$(_context) {
    while (1) {
...
function overcal() {
  var today, Todaysent, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, overcal;
  return regeneratorRuntime.async(function overcal$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('overcal')), 'overcal']],
            where: {
        ...
        case 19:
          overcal = _context3.sent;
          overcal.forEach(function _callee(e) {
            var lastDayOfMonth, overcalPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดcal " + e.overcal + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    overcalPercent = e.overcal / lastDayOfMonth * 100;
...
function checklistovecal(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistovecal$(_context7) {
    while (1) {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "\u0E04\u0E38\u0E13\u0E17\u0E32\u0E19\u0E40\u0E40\u0E04\u0E25\u0E2D\u0E23\u0E35\u0E40\u0E01\u0E34\u0E19 \u0E2B\u0E25\u0E32\u0E22\u0E27\u0E31\u0E19\u0E15\u0E34\u0E14\u0E01\u0E31\u0E19\u0E40\u0E40\u0E25\u0E49\u0E27\u0E19\u0E30 ".concat(name, " ( \u02D8\u25BD\u02D8)\u3063\u2668")
            }, {
              "type": "image",
