...
function overproteinnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function overproteinnoti$(_context) {
    while (1) {
...
function overprotein() {
  var today, Todaysent, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, overprotein;
  return regeneratorRuntime.async(function overprotein$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('overprotein')), 'overprotein']],
            where: {
        ...
        case 19:
          overprotein = _context3.sent;
          overprotein.forEach(function _callee(e) {
            var lastDayOfMonth, overproteinPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดprotein " + e.overprotein + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    overproteinPercent = e.overprotein / lastDayOfMonth * 100;
...
function checklistoveprotein(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistoveprotein$(_context7) {
    while (1) {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "".concat(name, " \u0E04\u0E38\u0E13\u0E17\u0E32\u0E19\u0E42\u0E1B\u0E23\u0E15\u0E35\u0E19\u0E21\u0E32\u0E01\u0E44\u0E1B\u0E19\u0E30 \u0E0A\u0E48\u0E27\u0E07\u0E19\u0E35\u0E49 \u0CA0 \u0CA0 ")
            }, {
              "type": "image",
...
module.exports = {
  overproteinnoti: overproteinnoti
};