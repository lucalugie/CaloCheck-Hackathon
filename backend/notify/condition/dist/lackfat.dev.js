...
function lackfatnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function lackfatnoti$(_context) {
    while (1) {
...
function lackfat() {
  var today, Todaysent, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, lackfat;
  return regeneratorRuntime.async(function lackfat$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('lackfat')), 'lackfat']],
            where: {
        ...
        case 19:
          lackfat = _context3.sent;
          lackfat.forEach(function _callee(e) {
            var lastDayOfMonth, lackfatPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดfat " + e.lackfat + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    lackfatPercent = e.lackfat / lastDayOfMonth * 100;
                    console.log("คิดเป็น " + lackfatPercent + " %");

                    if (lackfatPercent >= 50) {
                      checklistlackfat(e.userlineid, Todaysent);
                    }
            ...
            return regeneratorRuntime.async(function _callee3$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    console.log("id:" + element.userlineid + " count: " + element.lackfat);

                    if (!(element.lackfat >= 7)) {
                      _context5.next = 11;
                      break;
                    }
...
function checklistlackfat(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistlackfat$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "เดือนที่เเล้วคุณทานไขมัน ไม่ถึงเป้าหมายหลายวันเลยนะ ಠ_ಠ"
            }, {
              "type": "image",
              "originalContentUrl": "https://yungying.com/images/preme/checklist/5.png",
              "previewImageUrl": "https://yungying.com/images/preme/checklist/5.png"
            }, {
              "type": "text",
              "text": "เช็คร่างกายหน่อยสิ ว่าอยู่ในภาวะขาดไขมันไหม"
            }]
          }, {
            headers: {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "".concat(name, " \u0E04\u0E38\u0E13\u0E01\u0E34\u0E19\u0E44\u0E02\u0E21\u0E31\u0E19\u0E44\u0E21\u0E48\u0E16\u0E36\u0E07\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22\u0E21\u0E32 7 \u0E15\u0E34\u0E14\u0E01\u0E31\u0E19\u0E40\u0E40\u0E25\u0E49\u0E27\u0E19\u0E30")
            }, {
              "type": "image",
              "originalContentUrl": "https://yungying.com/images/preme/10.png",
              "previewImageUrl": "https://yungying.com/images/preme/10.png"
            }]
          }, {
            headers: {
              "Authorization": "Bearer ".concat(process.env.TOKEN_LINE_CALOCHECK)
