...
function overcarbnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function overcarbnoti$(_context) {
    while (1) {
...
function overcarb() {
  var today, Todaysent, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, overcarb;
  return regeneratorRuntime.async(function overcarb$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('overcarb')), 'overcarb']],
            where: {
        ...
        case 19:
          overcarb = _context3.sent;
          overcarb.forEach(function _callee(e) {
            var lastDayOfMonth, overcarbPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดcarb " + e.overcarb + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    overcarbPercent = e.overcarb / lastDayOfMonth * 100;
...
function checklistovecarb(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistovecarb$(_context7) {
    while (1) {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "".concat(name, " \u0E2A\u0E31\u0E1B\u0E14\u0E32\u0E2B\u0E4C\u0E19\u0E35\u0E49\u0E04\u0E38\u0E13\u0E01\u0E34\u0E19\u0E41\u0E1B\u0E49\u0E07\u0E40\u0E01\u0E34\u0E19\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22\u0E2B\u0E25\u0E32\u0E22\u0E27\u0E31\u0E19\u0E40\u0E40\u0E25\u0E49\u0E27\u0E19\u0E49\u0E32~ ")
            }, {
              "type": "image",
