...
function lackcarbnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function lackcarbnoti$(_context) {
    while (1) {
...
function lackcarb() {
  var today, Todaysent, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, lackcarb;
  return regeneratorRuntime.async(function lackcarb$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          console.log("check " + firstDayOfPreviousMonth.toLocaleDateString()); //วันสุดท้ายของเดือนที่เเล้ว
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('lackcarb')), 'lackcarb']],
            where: {
        ...
        case 19:
          lackcarb = _context3.sent;
          lackcarb.forEach(function _callee(e) {
            var lastDayOfMonth, lackcarbPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดcarb " + e.lackcarb + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    lackcarbPercent = e.lackcarb / lastDayOfMonth * 100;
...
function checklistlackcarb(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistlackcarb$(_context7) {
    while (1) {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "\u0E40\u0E2E\u0E49! ".concat(name, " \u0E04\u0E38\u0E13\u0E01\u0E34\u0E19\u0E04\u0E32\u0E23\u0E42\u0E1A\u0E44\u0E2E\u0E40\u0E14\u0E23\u0E15\u0E44\u0E21\u0E48\u0E16\u0E36\u0E07\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22\u0E21\u0E32 7 \u0E27\u0E31\u0E19\u0E40\u0E40\u0E25\u0E49\u0E27\u0E19\u0E30\u2027\xBA\xB7(\u02DA \u02C3\u0323\u0323\u0325\u2313\u02C2\u0323\u0323\u0325 )\u2027\xBA\xB7")
            }, {
              "type": "image",
