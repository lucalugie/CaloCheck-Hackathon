...
function overfatnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function overfatnoti$(_context) {
    while (1) {
...
function overfat() {
  var today, Todaysent, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, overfat;
  return regeneratorRuntime.async(function overfat$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('overfat')), 'overfat']],
            where: {
        ...
        case 19:
          overfat = _context3.sent;
          overfat.forEach(function _callee(e) {
            var lastDayOfMonth, overfatPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดfat " + e.overfat + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    overfatPercent = e.overfat / lastDayOfMonth * 100;
...
function checklistovefat(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistovefat$(_context7) {
    while (1) {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "\u0E40\u0E2E\u0E49! ".concat(name, " \u0E0A\u0E48\u0E27\u0E07\u0E19\u0E35\u0E49\u0E04\u0E38\u0E13\u0E44\u0E02\u0E21\u0E31\u0E19\u0E40\u0E01\u0E34\u0E19\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22\u0E17\u0E38\u0E01\u0E27\u0E31\u0E19\u0E40\u0E25\u0E22\u0E19\u0E30")
            }, {
              "type": "image",
