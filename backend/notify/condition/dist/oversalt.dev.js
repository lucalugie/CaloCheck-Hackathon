...
function oversaltnoti() {
  var currentTime, checkeveryday, TimeTocheck;
  return regeneratorRuntime.async(function oversaltnoti$(_context) {
    while (1) {
...
function oversalt() {
  var today, Todaysent, firstDayOfPreviousMonth, firstDayOfCurrentMonth, lastDayOfPreviousMonth, monthName, numberofPreviousMonth, oversalt;
  return regeneratorRuntime.async(function oversalt$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(noticonmonths.findAll({
            attributes: ['userlineid', [db.sequelize.fn('SUM', db.sequelize.col('oversalt')), 'oversalt']],
            where: {
        ...
        case 19:
          oversalt = _context3.sent;
          oversalt.forEach(function _callee(e) {
            var lastDayOfMonth, oversaltPercent;
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log("คุณ " + e.userlineid);
                    console.log("ขาดsalt " + e.oversalt + " วัน ในเดือน " + monthName); //เดือนนี้มี ....วัน

                    lastDayOfMonth = countDaysInMonth(firstDayOfPreviousMonth.getFullYear(), firstDayOfPreviousMonth.getMonth() + 1);
                    oversaltPercent = e.oversalt / lastDayOfMonth * 100;
...
function checklistovesalt(id, date) {
  var checknotiscon, token, checknoti, log;
  return regeneratorRuntime.async(function checklistovesalt$(_context7) {
    while (1) {
      ...
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          return regeneratorRuntime.awrap(axios.post("https://api.line.me/v2/bot/message/push", {
            ...
            messages: [{
              "type": "text",
              "text": "\u0E40\u0E2E\u0E49! ".concat(name, " 3 \u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E1C\u0E48\u0E32\u0E19\u0E21\u0E32\u0E14\u0E39\u0E40\u0E2B\u0E21\u0E37\u0E2D\u0E19\u0E04\u0E38\u0E13\u0E08\u0E30\u0E17\u0E32\u0E19\u0E42\u0E0B\u0E40\u0E14\u0E35\u0E22\u0E21\u0E40\u0E01\u0E34\u0E19\u0E01\u0E33\u0E2B\u0E19\u0E14\u0E19\u0E30")
            }, {
              "type": "image",
