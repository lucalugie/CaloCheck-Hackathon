          ...
          <>
            ...
            <PieChart
              series={[
                {
                  data: [
                    { value: findPercentage(nutri.ach_carb, nutri.ach_g), color: "#673ab7" },  //carb
                    { value: findPercentage(nutri.ach_protein, nutri.ach_g), color: "#e51c23" },  //protein
                    { value: findPercentage(nutri.ach_fat, nutri.ach_g), color: "#ffc107" },  //fat
                    { value: findPercentage(nutri.ach_veg, nutri.ach_g), color: "#259b24" },  //veg
                    { value: findPercentage(nutri.ach_sugar, nutri.ach_g), color: "#03a9f4" },  //sugar
                    { value: findPercentage(nutri.ach_salt, nutri.ach_g), color: "#3f51b5" },  //salt
                  ],
